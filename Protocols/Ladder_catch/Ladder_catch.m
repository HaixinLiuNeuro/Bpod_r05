...
GoTone = 3;% 5khz 2018-3-19 change to 3 kHz
...
for currentTrial = 1:MaxTrials
    ...
    if currentTrial>1 && TrialTypes(currentTrial-1)==2% if cue only trial last, make the ITI shorter -4 s
        current_iti=min_iti-3+range_iti*rand(1);
    else
    ...
    switch TrialTypes(currentTrial)
        ...
        case 2% tone only
            ...
            sma = AddState(sma, 'Name', 'GoCue', ...
                'Timer', GoToneDur,...
                'StateChangeConditions', {'Tup', 'LadderOFF'},...
                'OutputActions', {'Serial1Code', GoTone});
