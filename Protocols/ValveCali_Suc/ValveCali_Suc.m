...
if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
    S.GUI.WaterDuration = 0.015;
    S.GUI.TrialNum = 100;
    S.GUI.MinITI = 1;
    S.GUI.MaxITI = 2;
    S.GUI.RewardSoundDuration = 0.1;
end
...
%% Main trial loop
for currentTrial = 1:S.GUI.TrialNum % only run TrialNumber 
    ...
    sma = AddState(sma, 'Name', 'Reward', ...
        'Timer', S.GUI.WaterDuration,...
        'StateChangeConditions', {'Tup', 'RewardSound'},...
        'OutputActions', {'Serial1Code', 2, 'PWM3',255}); % PWM3 suc valve
    sma = AddState(sma, 'Name', 'RewardSound', ...
        'Timer', max(0,S.GUI.RewardSoundDuration-S.GUI.WaterDuration),...
