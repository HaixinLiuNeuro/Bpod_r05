...
for currentTrial = 1:MaxTrials
    ...
    if S.GUI.WN_ON == 0; %no white noise during licking
        ...
        sma = AddState(sma, 'Name', 'ITI', ...
            ...
            'OutputActions', {'Serial1Code', 255, Light, 255});
        
        sma = AddState(sma, 'Name', 'Reward', ...
            'Timer', S.GUI.ValveOpenDur,...
            'StateChangeConditions', {'Tup', 'exit'},...
            'OutputActions', {'PWM2',255,'Serial1Code', 255, Light, 255}); % open valve
        
        sma = AddState(sma, 'Name', 'Miss', ...
            'Timer', 0.0005,...
            'StateChangeConditions', {'Tup', 'exit'},...
            'OutputActions', {Light, 255}); % open valve
        ...
        sma = AddState(sma, 'Name', 'Reward', ...
            'Timer', S.GUI.ValveOpenDur,...
            'StateChangeConditions', {'Tup', 'exit'},...
            'OutputActions', {'PWM2',255,'Serial1Code', 250,Light, 255}); % open valve
        
        sma = AddState(sma, 'Name', 'Miss', ...
            'Timer', 0.0005,...
            'StateChangeConditions', {'Tup', 'exit'},...
            'OutputActions', {'Serial1Code', 255, Light, 255}); % open valve
    end
